...
| emo.debug             | Debug                                                         | Log debug information in the MODX error log.                                                                                                                                                          | No             |
...
| emo.selection_range   | Comma-separated list of enabled/disabled resource IDs for emo | Insert a comma-separated list with resource IDs, the plugin should (not) work on.                                                                                                                     | -              |
